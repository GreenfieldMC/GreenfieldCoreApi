...
public interface IBuildCodeService
{
    ...
    /// <returns>The build code if found; otherwise, null.</returns>
    ...
    /// <returns>The deleted build code if successful; otherwise, null.</returns>
    ...
    /// <returns>The created build code if successful; otherwise, null.</returns>
    ...
    /// <returns>The updated build code if successful; otherwise, null.</returns>
